<template>
  <section :class="[
    ...
    isNarrow ? 'items-center justify-center text-center' : ''
  ]">
    <!-- NAVBAR -->
    <nav class="flex justify-between items-center mb-14 w-full max-w-7xl" :class="isNarrow ? 'justify-center' : ''">
    ...
    <!-- MAIN CONTENT -->
    <div class="grid grid-cols-1 md:grid-cols-2 gap-16 items-center flex-1 w-full max-w-7xl"
      :class="[{ '4k:grid-cols-2 4k:gap-32 4k:px-64': is4K }, isNarrow ? 'justify-items-center' : '']">
      <!-- LEFT -->
      <div class="space-y-8" :class="{ '4k:space-y-16': is4K }">
        ...
        <div class="flex flex-wrap gap-5 items-center mt-4 4k:gap-10 4k:mt-8" :class="isNarrow ? 'justify-center' : ''">
          <button
