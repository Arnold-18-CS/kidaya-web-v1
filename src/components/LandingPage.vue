<template>
  <section
    :class="[
      'min-h-screen bg-gradient-to-r py-12 px-6 md:px-20 flex flex-col font-urbanist',
      darkMode
  ...
  >
    ...
    <nav class="flex justify-between items-center mb-14">
      ...
      <div class="flex items-center gap-4">
        ...
        >
          <svg v-if="!darkMode" xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-gray-700" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <!-- MAIN CONTENT -->
    <div
      class="grid grid-cols-1 md:grid-cols-2 gap-16 items-center flex-1"
    ...
    >
      ...
      <div class="space-y-8" :class="{ '4k:space-y-16': is4K }">
        <div>
          ...
          <h1
            class="text-4xl md:text-6xl font-extrabold leading-tight mb-4 4k:text-8xl"
        ...
        <p class="text-lg max-w-xl 4k:text-2xl 4k:max-w-3xl"
        ...
        <div v-show="!isNarrow" class="flex flex-wrap gap-6 items-center mt-8 4k:gap-12 4k:mt-16">
          <!-- App Store Button -->
          <a href="#"
      ...
      <div class="relative flex justify-center items-center">
        ...
        >
          <div class="flex -space-x-2 4k:-space-x-4">
            <img class="w-8 h-8 rounded-full border-2 border-white 4k:w-16 4k:h-16" src="/assets/avatar1.svg" alt="User 1" />
            <img class="w-8 h-8 rounded-full border-2 border-white 4k:w-16 4k:h-16" src="/assets/avatar2.svg" alt="User 2" />
            <img class="w-8 h-8 rounded-full border-2 border-white 4k:w-16 4k:h-16" src="/assets/avatar3.svg" alt="User 3" />
          </div>
          <div>
        ...
        >
          ...
          <p class="text-lg font-semibold 4k:text-3xl" :class="darkMode ? 'text-purple-300' : 'text-purple-700'">+35,890.00</p>
...
@media (min-width: 2560px) {
  ...
  .\34 k\:text-8xl { font-size: 6rem; line-height: 1; }
  .\34 k\:text-2xl { font-size: 1.5rem; }
  .\34 k\:text-xl { font-size: 1.25rem; }
  .\34 k\:text-lg { font-size: 1.125rem; }
  .\34 k\:max-w-3xl { max-width: 48rem; }
  .\34 k\:gap-10 { gap: 2.5rem; }
  .\34 k\:mt-8 { margin-top: 2rem; }
  .\34 k\:px-12 { padding-left: 3rem; padding-right: 3rem; }
  .\34 k\:py-5 { padding-top: 1.25rem; padding-bottom: 1.25rem; }
  .\34 k\:w-10 { width: 2.5rem; }
  .\34 k\:h-10 { height: 2.5rem; }
  .\34 k\:gap-12 { gap: 3rem; }
  .\34 k\:mt-16 { margin-top: 4rem; }
  .\34 k\:px-10 { padding-left: 2.5rem; padding-right: 2.5rem; }
  .\34 k\:py-4 { padding-top: 1rem; padding-bottom: 1rem; }
  .\34 k\:min-w-\[240px\] { min-width: 240px; }
  .\34 k\:max-w-\[300px\] { max-width: 300px; }
  .\34 k\:h-16 { height: 4rem; }
  .\34 k\:ml-6 { margin-left: 1.5rem; }
  .\34 k\:top-20 { top: 5rem; }
  .\34 k\:right-20 { right: 5rem; }
  .\34 k\:w-16 { width: 4rem; }
  .\34 k\:h-16 { height: 4rem; }
  ...
  .\34 k\:text-2xl { font-size: 1.5rem; }
  .\34 k\:left-20 { left: 5rem; }
  .\34 k\:bottom-10 { bottom: 2.5rem; }
  .\34 k\:w-\[420px\] { width: 420px; }
  .\34 k\:scale-150 { transform: scale(1.5); }
  .\34 k\:max-w-2xl { max-width: 42rem; }
  .\34 k\:gap-6 { gap: 1.5rem; }
  .\34 k\:px-8 { padding-left: 2rem; padding-right: 2rem; }
  .\34 k\:py-4 { padding-top: 1rem; padding-bottom: 1rem; }
  .\34 k\:text-base { font-size: 1rem; }
  .\34 k\:text-3xl { font-size: 1.875rem; }
}
